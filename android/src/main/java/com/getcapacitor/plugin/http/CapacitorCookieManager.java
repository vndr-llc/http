...
public class CapacitorCookieManager extends CookieManager {
    ...
    /**
     * Create a new cookie manager for use with @vndr/capacitor-http with the default cookie
     * store and policy
     */
    ...
    /**
     * Create a new cookie manager for use with @vndr/capacitor-http with specified cookie
