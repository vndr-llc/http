...
<p align="center"><strong><code>@vndr/capacitor-http</code></strong></p>
<p align="center">
...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@vndr/capacitor-http"><img src="https://img.shields.io/npm/l/@vndr/capacitor-http?style=flat-square" /></a>
<br>
  <a href="https://www.npmjs.com/package/@vndr/capacitor-http"><img src="https://img.shields.io/npm/dw/@vndr/capacitor-http?style=flat-square" /></a>
  <a href="https://www.npmjs.com/package/@vndr/capacitor-http"><img src="https://img.shields.io/npm/v/@vndr/capacitor-http?style=flat-square" /></a>
...
```bash
npm install @vndr/capacitor-http
npx cap sync
```
...
```bash
npm install @vndr/capacitor-http@0.x
```
