...
<p align="center"><strong><code>@vndrllc/capacitor-http</code></strong></p>
<p align="center">
...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@vndrllc/capacitor-http"><img src="https://img.shields.io/npm/l/@vndrllc/capacitor-http?style=flat-square" /></a>
<br>
  <a href="https://www.npmjs.com/package/@vndrllc/capacitor-http"><img src="https://img.shields.io/npm/dw/@vndrllc/capacitor-http?style=flat-square" /></a>
  <a href="https://www.npmjs.com/package/@vndrllc/capacitor-http"><img src="https://img.shields.io/npm/v/@vndrllc/capacitor-http?style=flat-square" /></a>
...
```bash
npm install @vndrllc/capacitor-http
npx cap sync
```
...
```bash
npm install @vndrllc/capacitor-http@0.x
```
