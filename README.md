...
<p align="center"><strong><code>@capacitor-vndr/http</code></strong></p>
<p align="center">
...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@capacitor-vndr/http"><img src="https://img.shields.io/npm/l/@capacitor-vndr/http?style=flat-square" /></a>
<br>
  <a href="https://www.npmjs.com/package/@capacitor-vndr/http"><img src="https://img.shields.io/npm/dw/@capacitor-vndr/http?style=flat-square" /></a>
  <a href="https://www.npmjs.com/package/@capacitor-vndr/http"><img src="https://img.shields.io/npm/v/@capacitor-vndr/http?style=flat-square" /></a>
...
```bash
npm install @capacitor-vndr/http
npx cap sync
```
...
```bash
npm install @capacitor-vndr/http@0.x
```
